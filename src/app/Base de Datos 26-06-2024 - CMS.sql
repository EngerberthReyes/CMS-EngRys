...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-06-2024 a las 07:36:24
...
(6, 1, 2, 1, 6, 'a', 'XD', 30434485, '/FotosDePerfil/Barranca Abajo.jpg', '2024-05-28', 'i@gmail.com', '$2a$11$f8AZ6mXW26XYtIMXhlc.yeB5rINTbQ5vRDdi84qO.sNxq/nTMzWX2', 'xd', '', '', '', '', '', NULL);
...
--
ALTER TABLE `publicaciones`
  MODIFY `id_publicacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=136;
