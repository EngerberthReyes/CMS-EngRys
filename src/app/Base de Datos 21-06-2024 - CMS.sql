...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-06-2024 a las 03:48:21
...
(1, 5, '<p>asddf</p>', '2024-06-16', '[]', '[]', '[]', NULL),
(2, 5, '<p>asddfxd</p>', '2024-06-16', '[]', '[]', '[]', NULL),
(3, 5, '<p>fddf</p>', '2024-06-16', '[]', '[]', '[]', NULL);
...
--
ALTER TABLE `publicaciones`
  MODIFY `id_publicacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=120;
