...
export const PUT = async (request) => {
  try {
    const { descripcionPerfilModificacion } = await request.json();
    console.log(descripcionPerfilModificacion);
    const elementosActualizar = {
      descripcion_personal: descripcionPerfilModificacion,
    };
    ...
    const response = new NextResponse(JSON.stringify(elementosActualizar.descripcion_personal), {
      headers: {
