...
(1, 2, 1, 'La PC Gamer de Tus S', '<p>ELE</p>'),
(2, 3, 1, 'Innovación', 'xd'),
(3, 3, 1, 'Calidad', 'Calidad: Nos esforzamos por ofrecer productos y servicios de la más alta calidad, garantizando la satisfacción de nuestros clientes.'),
(4, 3, 1, 'Servicio al Cliente', 'Servicio al Cliente: Priorizamos el trato personalizado y la atención detallada a nuestros clientes, entendiendo que cada proyecto es único y requiere un enfoque individualizado.'),
(5, 3, 1, 'Responsabilidad Soci', 'Responsabilidad Social: Reconocemos nuestro papel en la comunidad y nos comprometemos a contribuir positivamente a través de iniciativas sociales y educativas.'),
(6, 3, 1, 'Historia', '<p>xddDasdasd</p>'),
(7, 3, 1, 'Misión', 'asdasda sd as d'),
(8, 3, 1, 'Visión', 'Aspiramos a liderar el mercado de computadoras mediante la innovación constante, la excelencia en el servicio y la construcción de relaciones duraderas basadas en la confianza y el respeto mutuo. Queremos ser reconocidos no solo por nuestras soluciones tecnológicas avanzadas, sino también por nuestra contribución a la sociedad a través de la promoción de la educación y el acceso a la tecnología.');
...
(124, 5, '<p>', '2024-06-16', '[]', '[]', NULL, '[\"https://www.youtube.com/watch?v=cbzfjuq9w2A\"]'),
(125, 4, '<p>que dijo su hijo detras del barbijo</p>', '2024-06-16', '[]', '[]', NULL, '[]'),
(126, 4, '<p>que dijo su hijo detrás del barbijo</p>', '2024-06-16', '[]', '[]', NULL, '[]'),
(127, 4, '<p>fg</p>', '2024-06-16', '[]', '[]', NULL, '[]'),
(133, 5, '<p><strong><em>dg</em></strong></p>', '2024-06-17', '[]', '[\"/FotosEnPublicaciones/Barranca Abajo  CD.jpg\"]', NULL, '[]'),
...
--
ALTER TABLE `publicaciones`
  MODIFY `id_publicacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=135;
