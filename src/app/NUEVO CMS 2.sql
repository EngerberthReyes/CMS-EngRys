...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-06-2024 a las 09:27:26
...
(1, 1, 1, 1, 15, 'adasd', 'sdasd', 30434485, '0000-00-00', 'engerberthr73@gmail.com', '4535353535', NULL, NULL, NULL, NULL, NULL, 'A', 'A'),
(9, 1, 1, 1, 23, 'HOLA', 'ADIOS', 234234234, '0000-00-00', '3rthr73@gmail.com', '3rthr73@gmail.com3rthr73@gmail.com', NULL, NULL, NULL, NULL, NULL, 'A', 'A'),
(11, 1, 1, 1, 29, 'asdasd', 'sdasd', 2323, '2024-05-27', 'engerberthr73@gmail.com', 'http://localhost:3000/registro', NULL, NULL, NULL, NULL, NULL, 'A', 'A');
...
--
ALTER TABLE `codigos_postales`
  MODIFY `id_codigo_postal` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
...
--
ALTER TABLE `municipios`
  MODIFY `id_municipio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
...
--
ALTER TABLE `parroquias`
  MODIFY `id_parroquia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
